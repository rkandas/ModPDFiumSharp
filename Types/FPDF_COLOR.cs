...
namespace HorizonPDFAPI.Types
{
    ...
    {
        [FieldOffset(0)] readonly byte _a;
        [FieldOffset(1)] readonly byte _r;
        [FieldOffset(2)] readonly byte _g;
        [FieldOffset(3)] readonly byte _b;
        [FieldOffset(0)] readonly uint _argb;
